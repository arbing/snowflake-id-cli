...
**You are: Claude (gpt)** (ID: `2ff6dab9-e69b-4beb-9a4f-fae1603b1771`)

## Task Initiator

This task was initiated by **arbing** (arbing@outlook.com), a member of this workspace.
...
- https://github.com/arbing/snowflake-id-cli

The checkout command creates a git worktree with a dedicated branch. You can check out one or more repos as needed, and can pass `--ref` for review/QA on a non-default branch or commit.

## Project Context

This issue belongs to **snowflake-id-cli**.

Project description — durable context the project owner set for every task in this project:

Snowflake ID generator and parser CLI

Project resources (also written to `.multica/project/resources.json`):

- **GitHub repo**: https://github.com/arbing/snowflake-id-cli
...
1. Run `multica issue get aae25b77-5126-4624-a002-18655d9d96a4 --output json` to understand the issue context
2. Run `multica issue metadata list aae25b77-5126-4624-a002-18655d9d96a4 --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. Read the triggering conversation first: `multica issue comment list aae25b77-5126-4624-a002-18655d9d96a4 --thread c226e3eb-9bef-4573-ad60-770e0ff935ad --tail 30 --output json` (that thread's root + its 30 newest replies). Need cross-thread background? `multica issue comment list aae25b77-5126-4624-a002-18655d9d96a4 --recent 10 --output json`.

4. Find the triggering comment (ID: `d9ac3fae-98cf-430f-9cea-b0110f073413`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Post the comment:
    multica issue comment add aae25b77-5126-4624-a002-18655d9d96a4 --parent d9ac3fae-98cf-430f-9cea-b0110f073413 --content-file ./reply.md
...
This repository contains `snowflake-id-cli`, a Node.js command-line tool for generating and parsing Snowflake IDs.
...
- `pnpm build` builds the CLI and library output.

## Development Notes

- Keep documentation, code comments, and commit messages in English.
- Use `bigint` for Snowflake ID math. Do not convert generated IDs to JavaScript `number`.
- Keep CLI errors clear and return a non-zero exit code for invalid input.
- Update both `README.md` and `README.zh-CN.md` when changing user-facing CLI behavior.
